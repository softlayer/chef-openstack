h1. GitHub Page for Chef-OpenStack

Our GitHub Page for Chef-OpenStack is a branded theme made using "Bootstrap CSS":http://getboostrap.com and served up by "Jekyll":http://jekyllrb.com/docs/home on their website. It is a minimal way to create static landing pages for each repo and publish them on our GitHub Pages.
...
You can easily modify the GitHub URL by modifying three references:
