...
default["keystone"]["config"]["token_format"] = "UUID"
...
default["keystone"]["default_accounts"]["users"] = {
	...
	"quantum" => {"email" => "quantum@localhost", "password" => node[:admin][:password] },
...
default["keystone"]["default_accounts"]["services"] = {
	...
	"quantum" => {"type" => "network", "description" => "OpenStack Networking service" }
}
default["keystone"]["default_accounts"]["user-roles"] = [
	...
	{"role" => "admin", "user" => "quantum", "tenant" => "service" },
